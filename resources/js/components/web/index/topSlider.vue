<template>
  <section class="flickity skeleton" v-if="animeList.length === 0">
    <div class="flickity-inner" style=" justify-content: center;">
      <div class="gallery-cell skeleton-cell-pulse skeleton-bg" style="margin: 10px 0 0 0; filter: grayscale(0)"></div>
    </div>
  </section>
        ...
        <div class="flickity-content-gallery-block">
          <div class="gallery-cell-content">
            ...
            <div class="gallery-cell-info">
              ...
              <button class="pd-normal raco-secondary" style="margin-top: 5px;"><i class="fa-solid fa-play"></i>Cмотреть
              </button>
            </div>
          </div>
        </div>
